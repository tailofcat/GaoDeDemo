...
app.all('/amap/api/*', (req, res) => {
  proxyRequest(req, res, 'https://webapi.amap.com', '/amap/api', { key: AMAP_KEY });
});

app.all('/_AMapService/v4/map/styles/*', (req, res) => {
  proxyRequest(req, res, 'https://webapi.amap.com', '/_AMapService/v4/map/styles', { jscode: AMAP_SECURITY_KEY });
});
